...
#ini maunya takkasi batas maksimal 10-11 digit, nah kalo gabisa nanti looping sampe ngisi bener
...
def bills():
    ...
    print("Date      :",datetime_laundry)
    print("Customer  : {}".format(cust_name))
    print("Phone Num : {}".format(cust_phone))
...
while flag == 1:
    cust_phone = input("Silahkan masukkan nomer HP customer : ")
    if type(cust_phone) != int and len(str(cust_phone)) != 10:
